...
var _singleRecipe = require('./views/recipe/single-recipe.vue');
...
},{"./views/grocerylists/all-grocery-lists.vue":43,"./views/grocerylists/create-grocery-list.vue":44,"./views/recipe/add-recipe.vue":45,"./views/recipe/single-recipe.vue":46,"vue":41,"vue-resource":40}],43:[function(require,module,exports){
"use strict";
...
},{"vue":41,"vue-hot-reload-api":39}],44:[function(require,module,exports){
"use strict";
...
exports.default = {
    data: function data() {
        return {
            ...
            unaddedRecipes: (0, _assign2.default)({}, PepperRodeo.recipes),
            addedRecipes: [],
            recipesToAdd: []
        };
    },
    methods: {
        ...
        addRecipes: function addRecipes(recipeIds) {
            var self = this;
...
},{"babel-runtime/core-js/object/assign":1,"vue":41,"vue-hot-reload-api":39}],45:[function(require,module,exports){
'use strict';
...
},{"vue":41,"vue-hot-reload-api":39}],46:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-794de0b7", module.exports)
  } else {
    hotAPI.update("_v-794de0b7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":41,"vue-hot-reload-api":39}]},{},[42]);
